...
const useWallet = () => ({ address: null as string | null, connected: false, disconnect: async () => {}, requestSend: null as any, wallet: null });
class SendTransaction { constructor(..._args: any[]) {} }
        ...
        {paymentSuccess ? (
          ...
          <>
            ...
            <div className="flex flex-col gap-5 py-5 w-[80%]">
              <PaymentLinkPreview
                recipient={(paymentLink as any).company?.companyName || (paymentLink as any).recipientName || ""}
                recipientAvatar={(paymentLink as any).company?.companyLogo || null}
                paymentWalletAddress={(paymentLink as any).paymentWalletAddress || (paymentLink as any).recipientAddress || ""}
