import { InvoiceStatusEnum, CurrencyEnum } from '../enums/index';
import { PaginationMetaDto } from './common';
import { NetworkDto } from './network';
import { TokenDto } from './token';

// Type alias for backwards compatibility with server's Currency type
export type Currency = CurrencyEnum;
export const Currency = CurrencyEnum;
...
export interface UpdateInvoiceDto {
  ...
  total?: string;
  metadata?: Record<string, any>;
  // Payment details that can be updated
  token?: TokenDto;
  network?: NetworkDto;
  walletAddress?: string;
  address?: string;
...
export interface InvoiceScheduleResponseDto {
  ...
  generateDaysBefore: number;
  isActive: boolean;
  nextGenerateDate?: string | Date;
  lastGeneratedAt?: string | Date;
  createdAt: string | Date;
  updatedAt: string | Date;
}

export interface InvoiceModelDto {
  id: number;
  uuid: string;
  createdAt: string;
  updatedAt: string;
...
export type InvoiceModel = InvoiceModelDto;
