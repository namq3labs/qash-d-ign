                      ...
                      {balances && balances.balances.length > 0 ? (
                        [...balances.balances]
                          .sort((a, b) => {
                            ...
                            if (aSymbol === "USDT") return -1;
                            if (bSymbol === "USDT") return 1;
                            return 0;
                          })
                          .map((asset, index: number) => {
                            ...
                            const token = {
                              ...
                              metadata: {
                                ...
                                maxSupply: (asset as any).maxSupply || supportedToken?.maxSupply || 0,
                              },
                              amount: asset.balance,
                              value: "1",
                              icon: symbol === "USDT" ? "/token/usdt.svg" : blo(turnBechToHex(asset.assetId)),
                              chain: "Miden",
                            };
